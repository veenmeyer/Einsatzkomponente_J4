...
if ($saveOrder)
{
	...
	JHtml::_('sortablelist.sortable', 'kategorieList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_einsatzkomponente&view=kategorien'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="kategorieList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_EINSATZKOMPONENTE_KATEGORIEN_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'kategorien.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
				<td>
