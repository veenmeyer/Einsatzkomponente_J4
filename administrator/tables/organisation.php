 ...
 */
class EinsatzkomponenteTableorganisation extends JTable {
    /**
     * Constructor
     *
    ...
    public function bind($array, $ignore = '') {
		...
		if(!JFactory::getUser()->authorise('core.edit.state','com_einsatzkomponente.organisation.'.$array['id']) && $array['state'] == 1){
			$array['state'] = 0;
		}
